      ...
      <div className="absolute z-20 top-0 left-0 right-0 bottom-0 md:w-1/2 w-full flex items-center md:items-end justify-center md:justify-start">
        <div className="px-8 py-8">
          <div className="space-y-6 md:text-left text-center">
            <h1 className="md:text-3xl lg:text-4xl text-2xl font-poppins font-semibold text-gray-400">
              Hey, I'm <span className="font-bold font-montserrat text-gray-600">Rizki</span>
            </h1>
            <h2 className="md:text-4xl lg:text-5xl text-3xl font-poppins font-extrabold text-gray-600">
              FrontEnd Developer
            </h2>
          </div>
          <p className="md:text-left text-center mt-4 mb-10 text-gray-400">
